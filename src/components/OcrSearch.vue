		...
		<ion-header>
			<ion-toolbar>
				<ion-buttons slot="end">
					<ion-buttons color="medium" @click="dismiss"
						>الغاء</ion-buttons
					>
				</ion-buttons>
		...
		async searchDrug() {
			...
			this.products.forEach(async (product) => {
				...
				if (
					...
					console.log(
						`Found in ${product.pharmacy.name}'s pharmacy . `
					);
				} else {
